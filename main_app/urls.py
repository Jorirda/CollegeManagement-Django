...
#hodviews
    ...
    path("teacher/view/summary/", hod_views.teacher_summary_message,name="teacher_summary_message",),
    ...
    path("teacher/view/summary/", teacher_views.teacher_summary, name='teacher_summary'),
