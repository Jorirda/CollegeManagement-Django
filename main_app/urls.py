...
#hodviews
    ...
    path("teacher/view/feedback/", hod_views.teacher_feedback_message,name="teacher_feedback_message",),
    ...
    path("teacher/delete/<int:notification_id>/", teacher_views.teacher_delete_notification, name='teacher_delete_notification'),
